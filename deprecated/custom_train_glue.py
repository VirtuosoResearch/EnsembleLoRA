...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_sample_weights_dir", type=str, default="sample_weights")
    ...
    for run in range(args.runs):
        ...
        lm = GLUEModel(model, tokenizer, model_type, use_cpu_offload=False,
                        ...
                        answer_choices=answer_choices, optimizer=args.optimizer, generate_output=args.generate_output, use_sample_weights=args.use_sample_weights)
