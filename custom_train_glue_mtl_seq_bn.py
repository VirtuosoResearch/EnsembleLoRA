...
from peft import   PeftType, PrefixTuningConfig, TaskType

import numpy as np

class CustomPeftConfig(PrefixTuningConfig): 
    def __init__(self, num_virtual_tokens=20, **kwargs):
        super().__init__(num_virtual_tokens=num_virtual_tokens, **kwargs)
